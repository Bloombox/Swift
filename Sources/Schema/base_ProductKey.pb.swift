...
public struct Opencannabis_Base_ProductReference: SwiftProtobuf.Message {
...
public struct Opencannabis_Base_ProductKey: SwiftProtobuf.Message {
...
extension Opencannabis_Base_ProductReference: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension Opencannabis_Base_ProductKey: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "type"),
  ]
