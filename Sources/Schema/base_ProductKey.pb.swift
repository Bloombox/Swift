...
public struct Base_ProductReference: SwiftProtobuf.Message {
...
public struct Base_ProductKey: SwiftProtobuf.Message {
  ...
  public var type: Base_ProductType {
    get {return _storage._type ?? Base_ProductType()}
...
extension Base_ProductReference: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Base_ProductReference) -> Bool {
...
extension Base_ProductKey: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "type"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _type: Base_ProductType? = nil
  ...
  public func _protobuf_generated_isEqualTo(other: Base_ProductKey) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let other_storage = _args.1
