...
public struct Bloombox_Schema_Services_Telemetry_V1beta3_TelemetryEvent: SwiftProtobuf.Message {
  ...
  /// Sections: Impression.
  public var impression: Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Impression {
    get {
      if case .impression(let v)? = _storage._event {return v}
      return Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Impression()
    }
    set {_uniqueStorage()._event = .impression(newValue)}
  }

  /// Sections: View.
  public var view: Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.View {
    get {
      if case .view(let v)? = _storage._event {return v}
      return Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.View()
    }
    set {_uniqueStorage()._event = .view(newValue)}
  }

  /// Sections: Action.
  public var action: Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Action {
    get {
      if case .action(let v)? = _storage._event {return v}
      return Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Action()
    }
    set {_uniqueStorage()._event = .action(newValue)}
  }

  /// Users: Action.
  public var userAction: Bloombox_Schema_Services_Telemetry_V1beta3_IdentityEvent.Action {
    get {
      if case .userAction(let v)? = _storage._event {return v}
      return Bloombox_Schema_Services_Telemetry_V1beta3_IdentityEvent.Action()
    }
  ...
  public enum OneOf_Event: Equatable {
    ...
    /// Sections: Impression.
    case impression(Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Impression)
    /// Sections: View.
    case view(Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.View)
    /// Sections: Action.
    case action(Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Action)
    /// Users: Action.
    case userAction(Bloombox_Schema_Services_Telemetry_V1beta3_IdentityEvent.Action)

    public static func ==(lhs: Bloombox_Schema_Services_Telemetry_V1beta3_TelemetryEvent.OneOf_Event, rhs: Bloombox_Schema_Services_Telemetry_V1beta3_TelemetryEvent.OneOf_Event) -> Bool {
      switch (lhs, rhs) {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 20:
          var v: Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Impression?
          if let current = _storage._event {
            try decoder.handleConflictingOneOf()
        ...
        case 21:
          var v: Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.View?
          if let current = _storage._event {
            try decoder.handleConflictingOneOf()
        ...
        case 22:
          var v: Bloombox_Schema_Services_Telemetry_V1beta3_CommercialEvent.Action?
          if let current = _storage._event {
            try decoder.handleConflictingOneOf()
        ...
        case 30:
          var v: Bloombox_Schema_Services_Telemetry_V1beta3_IdentityEvent.Action?
          if let current = _storage._event {
            try decoder.handleConflictingOneOf()
