...
public struct Services_Telemetry_V1beta2_OrderAction: SwiftProtobuf.Message {
  public static let protoMessageName: String = _protobuf_package + ".OrderAction"
  ...
  public var action: Analytics_Order_Action {
    get {return _storage._action ?? Analytics_Order_Action()}
...
extension Services_Telemetry_V1beta2_OrderAction: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _action: Analytics_Order_Action? = nil
  ...
  public func _protobuf_generated_isEqualTo(other: Services_Telemetry_V1beta2_OrderAction) -> Bool {
