...
public struct Bloombox_Services_Shop_V1_EnrollMember {
  ...
  public struct Request {
    ...
    /// Device that is performing this enrollment, if it is indeed happening on a physical/managed device.
    public var deviceID: String {
      get {return _storage._deviceID}
      set {_uniqueStorage()._deviceID = newValue}
    }

    /// Whether this is an "early" enrollment, in which case the flow requires much less information, and provides a cue
    /// to the user to continue the flow later.
    public var early: Bool {
      get {return _storage._early}
      set {_uniqueStorage()._early = newValue}
    }

    /// Flag indicating that this enrollment is happening as part of an order submission flow.
    public var preOrder: Bool {
      get {return _storage._preOrder}
      set {_uniqueStorage()._preOrder = newValue}
    }
...
public struct Bloombox_Services_Shop_V1_SubmitOrder {
  ...
  public struct Request {
    ...
    /// Name of the device submitting the order, if applicable.
  ...
  public struct Response {
    ...
    /// Characters allocated to identify this order locally.
    public var orderNumber: String = String()
...
public struct Bloombox_Services_Shop_V1_GetOrder {
  ...
  public struct Request {
    ...
    public var orderNumber: String {
      get {return _storage._orderNumber}
      set {_uniqueStorage()._orderNumber = newValue}
    }
...
extension Bloombox_Services_Shop_V1_EnrollMember.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "device_id"),
    11: .same(proto: "early"),
    12: .standard(proto: "pre_order"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _early = source._early
      _preOrder = source._preOrder
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 10: try decoder.decodeSingularStringField(value: &_storage._deviceID)
        case 11: try decoder.decodeSingularBoolField(value: &_storage._early)
        case 12: try decoder.decodeSingularBoolField(value: &_storage._preOrder)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._deviceID.isEmpty {
        try visitor.visitSingularStringField(value: _storage._deviceID, fieldNumber: 10)
      }
      if _storage._early != false {
        try visitor.visitSingularBoolField(value: _storage._early, fieldNumber: 11)
      }
      if _storage._preOrder != false {
        try visitor.visitSingularBoolField(value: _storage._preOrder, fieldNumber: 12)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Bloombox_Services_Shop_V1_EnrollMember.Request, rhs: Bloombox_Services_Shop_V1_EnrollMember.Request) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._early != rhs_storage._early {return false}
        if _storage._preOrder != rhs_storage._preOrder {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularMessageField(value: &_storage._phone)
        default: break
        }
      }
    }
...
extension Bloombox_Services_Shop_V1_SubmitOrder.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularStringField(value: &self.orderNumber)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.orderNumber.isEmpty {
      try visitor.visitSingularStringField(value: self.orderNumber, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Bloombox_Services_Shop_V1_GetOrder.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _location: Bloombox_Partner_LocationKey? = nil
    var _orderNumber: String = String()
    ...
    init(copying source: _StorageClass) {
      ...
      _location = source._location
      _orderNumber = source._orderNumber
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularMessageField(value: &_storage._location)
        case 3: try decoder.decodeSingularStringField(value: &_storage._orderNumber)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._orderNumber.isEmpty {
        try visitor.visitSingularStringField(value: _storage._orderNumber, fieldNumber: 3)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Bloombox_Services_Shop_V1_GetOrder.Request, rhs: Bloombox_Services_Shop_V1_GetOrder.Request) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._location != rhs_storage._location {return false}
        if _storage._orderNumber != rhs_storage._orderNumber {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
