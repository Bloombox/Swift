...
extension PointOfSaleClient: IPOSAuthorizeUser {
  ...
  // MARK: Public API
  /**
   * Authorize a user account for a staff member to make use of point-of-sale hardware, using an identity token provided
   * via user auth, for an account that has never been used on POS before or has lost their passcode.
   */
