...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/bloombox/swift", .upToNextMinor(from: "0.1.8"))])
```

Via **Carthage**:
```
github "bloombox/swift" ~> 0.1.8
```
